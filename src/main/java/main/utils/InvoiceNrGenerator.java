...
public class InvoiceNrGenerator extends Sequence implements SessionCustomizer {
    ...
    public Object getGeneratedValue(Accessor accessor, AbstractSession abstractSession, String s) {
        Long lastUsedInvoiceNr = this.invoiceService.findLastInvoiceNr();
        return this.invoiceService.getNextInvoiceNr(lastUsedInvoiceNr);
    }
    ...
    public void customize(Session session) throws Exception {
        InvoiceNrGenerator sequence = new InvoiceNrGenerator("invoicenr");
